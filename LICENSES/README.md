# Third-party licenses in kUI

kUI's own code is GPL-3.0 (see /LICENSE). Everything below ships with a
release but is not kUI code.
...
fonts with software (sold or free); the fonts may not be SOLD on their
own. Full text: `LICENSES/OFL.txt`.
